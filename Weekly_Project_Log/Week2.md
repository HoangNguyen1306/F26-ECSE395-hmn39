...
- Built a circuit to blink ESP32 LEDs and finished up the lab assignment.

## *Lab 2 Activities: Learning ESP32*
- 4th September 2026: Managed to learn how to use Arduino, ESP32 extensions on VSCode similar to how I coded on ArduinoIDE prior to this class.
- 4th September 2026: Created `esp32_basic.md` and `Week2.md`, placed them in the correct repository folders, staged, committed, and pushed changes to GitHub.

## *Next Week Task (9/7 - 9/11)*
- Follow up and ask the stakeholder more questions via email 
- Asking the stakeholder for the window's photo to confirm the exact size, shapem, location and type of the window.
